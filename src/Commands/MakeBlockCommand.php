...
namespace Mo_sweed\DropBlockEditor\Commands;
...
class MakeBlockCommand extends Command
{
    ...
    {
        return base_path('app/Classes/Blocks') . '/' . $this->getSingularClassName($this->argument('name')) . '.php';
    }
    ...
    public function getEditComponentSourceFilePath(): string
    {
        ...
        return base_path('app/Livewire/DropBlockEditor/Components') . '/' . $this->getSingularClassName($this->argument('name')) . '.php';
    }
    ...
    public function handle(): int
    {
        ...
        File::put($blockPath, $this->getStubContents(__DIR__ .'/'.'block.edit-component.stub', [
            ...
            'edit-component-name' => 'DropBlockEditor.Components.'.Str::kebab($this->argument('name')),
        ]));
